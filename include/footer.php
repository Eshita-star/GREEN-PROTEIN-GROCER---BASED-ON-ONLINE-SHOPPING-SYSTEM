...
{
    extract($_POST);
    $q2="INSERT INTO `message`(`name`, `email`, `message`) VALUES ('$name','$email','$fdm')";
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <form action="" method="post">
                        <div class="card mt-2">
                            <h3 class="tittle-w3" style="text-align: center; color: orange; font-size: 30px;"><span
                                    style="color: black;">SEND a </span>MESSAGE</h3>
                            <div class="card-body mt-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="fdm" id="" rows="3"></textarea>
                                </div>
